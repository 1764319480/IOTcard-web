        ...
        <div class="filter">
            <div class="form">
                <el-form :inline="true" :model="formInline" ref="ruleFormRef" class="demo-form-inline">
                    ...
                    <el-form-item>
                        <el-button type="primary" :icon="Search" @click="getUserList()" :loading="stopClick">搜索</el-button>
        ...
        <div class="lists">
            ...
            <template v-for="(item) in userList" :key="item.id">
                <div>
                    ...
                    <div><el-switch inline-prompt active-text="启用" inactive-text="禁用" active-value="1" inactive-value="0" v-model="item.status" />
                    </div>
